...
snakemake <- Snakemake(
    ...
    log = list(),
    resources = list(),
    config = list("blast_database" = 'uniprotkb_bacteria', "identity_cut_off" = 60, "mail" = 'r.beeloo@outlook.com', "blast_max_alignments" = 250, "min_con_score" = 400, "e_value_cut_off" = 0.05, "maximum_articles_retrieve" = 10, "max_numb_con" = 20),
    rule = 'orthologs'
)
######## Original script #########
