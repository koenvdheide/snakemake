...
snakemake <- Snakemake(
    ...
    log = list(),
    resources = list(),
    config = list("max_numb_con" = 20, "min_con_score" = 400, "blast_database" = 'uniprotkb_bacteria', "identity_cut_off" = 60, "maximum_articles_retrieve" = 10, "blast_max_alignments" = 250, "mail" = 'r.beeloo@outlook.com', "e_value_cut_off" = 0.05),
    rule = 'orthologs'
)
######## Original script #########
